...
CamShake:Stop()
    ...
    local i = "Banana Hub-[BETA]•by Obii🍌"
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Banana Hub-[BETA]•by Obii🍌 chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Banana Hub-[BETA]•by Obii🍌", HidePremium = false, IntroText = "Banana Hub-[BETA]•by Obii🍌⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "Banana Hub-[BETA]•by Obii🍌",
...
W:AddLabel("Banana Hub-[BETA]•by Obii🍌")
...
W:AddLabel("Banana Hub-[BETA]•by Obii🍌 SCRIPT")
W:AddLabel("DiscordBanana Hub-[BETA]•by Obii🍌")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Banana Hub-[BETA]•by Obii🍌(Noitification)",
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    OrionLib:MakeNotification({
                        Name = "Banana Hub-[BETA]•by Obii🍌 BOT",
